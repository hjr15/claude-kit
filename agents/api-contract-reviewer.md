...
5. If a breaking change is genuinely needed, say so and require a version bump + deprecation path rather than rubber-stamping it — and flag it ADR-worthy if it sets a lasting convention.
