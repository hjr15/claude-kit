...
- LCP <2.5s / <4s / >4s · INP (was FID) <200ms / <500ms / >500ms · CLS <0.1 / <0.25 / >0.25
- FCP <1.8s / <3s · TTI <3.8s / <7.3s — measure with Lighthouse / WebPageTest / the Performance Observer API
