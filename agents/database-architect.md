...
- Use connection pooling (and pool segmentation under mixed workloads)
- Cache frequently accessed data
- Partition large tables when appropriate
- Use materialized views for expensive, frequently-read aggregations
- Add read replicas to scale reads; separate OLTP from heavy OLAP/reporting work
- Profile slow queries with EXPLAIN/slow-query logs and index to the access pattern
